...
contents: {
"req_open-home-page-38ec6": {
        type: "REQUEST",
        name: "Open home page",
path: "Open home page",
pathFormatted: "req_open-home-page-38ec6",
stats: {
    "name": "Open home page",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_input-keyword-5d42e": {
        type: "REQUEST",
        name: "Input keyword",
path: "Input keyword",
pathFormatted: "req_input-keyword-5d42e",
stats: {
    "name": "Input keyword",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_open-product-pa-7c7ec": {
        type: "REQUEST",
        name: "Open product page",
path: "Open product page",
pathFormatted: "req_open-product-pa-7c7ec",
stats: {
    "name": "Open product page",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_add-to-cart-2d0f6": {
        type: "REQUEST",
        name: "Add to cart",
path: "Add to cart",
pathFormatted: "req_add-to-cart-2d0f6",
stats: {
    "name": "Add to cart",
    "numberOfRequests": {
        "total": "1",
...
stats: {
    ...
    },"req_go-to-shopping--bed9d": {
        type: "REQUEST",
        name: "Go to shopping cart",
path: "Go to shopping cart",
pathFormatted: "req_go-to-shopping--bed9d",
stats: {
    "name": "Go to shopping cart",
    "numberOfRequests": {
        "total": "1",
